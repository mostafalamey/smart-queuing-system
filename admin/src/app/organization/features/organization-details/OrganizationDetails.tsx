import { Building2, Upload, X, Users, Palette, Globe, Phone, Mail, MapPin, MessageSquare } from 'lucide-react'
    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="lg:col-span-2 card p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Essential organization details</p>
            </div>
          </div>
      ...
      <div className="card p-6 hover:shadow-lg transition-all duration-300 mb-6">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">Customer Experience</h2>
            <p className="text-sm text-gray-500">Welcome message and customer-facing settings</p>
          </div>
        </div>
