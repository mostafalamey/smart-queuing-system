...
export default function EditDepartmentModal({ isOpen, onClose, department, onSave }: EditDepartmentModalProps) {
    ...
    <Portal>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="departmentDescription" className="block text-sm font-medium text-gray-700 mb-2">
              Description
            </label>
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-celestial-500 focus:border-transparent transition-all duration-200 resize-none"
