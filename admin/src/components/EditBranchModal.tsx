...
interface EditBranchModalProps {
  ...
  onSave: (id: string, name: string, address: string, phone: string, email: string) => Promise<void>;
}

export default function EditBranchModal({ isOpen, onClose, branch, onSave }: EditBranchModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await onSave(branch.id, name.trim(), address.trim(), phone.trim(), email.trim());
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-semibold text-gray-800">Edit Branch</h3>
            <button
              onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="branchPhone" className="block text-sm font-medium text-gray-700 mb-2">
              Phone
            </label>
            <input
              type="tel"
          ...
          <div>
            <label htmlFor="branchEmail" className="block text-sm font-medium text-gray-700 mb-2">
              Email
            </label>
            <input
              type="email"
